...
export default function DropFiles({ childToParent }) {
  ...
  function uploadFile(files) {
    ...
    formData.append('api_key', '339498149462851');
      ...
      <div className="dzu-dropzone">
        ...
        {previewVideo === false ? (
          <div>
            <div {...getRootProps()}>
              ...
              <div className="Dropzone-inputContents">
                ...
                <div>Drag and drop multiple files</div>
                <div>
                  <p>
                    or <span>browse</span> to choose files
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="video-container">
            <video key={previewVideo} controls width="100%" height="100%">
